...
const Dashboard = () => {
  ...
  const { notes, loading, error, fetchNotes, deleteNote, shareNote, clearError } = useNotes();
                    ...
                    <div className="flex-1">
                      ...
                      {note.note_type === 'shared' && (
                        <p className="text-xs text-gray-500 mb-2">
                          Shared by {note.owner_username} • {note.permission === 'edit' ? 'Can edit' : 'Read only'}
                        </p>
                      )}
                    </div>
      ...
      {shareModal.isOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full mx-4 animate-fade-in">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Share with another user</p>
                </div>
              </div>
              <button
            ...
            <div className="p-6">
              <div className="bg-gray-50 rounded-xl p-4 mb-6">
                <p className="font-semibold text-gray-900 truncate">"{shareModal.noteTitle}"</p>
              </div>
